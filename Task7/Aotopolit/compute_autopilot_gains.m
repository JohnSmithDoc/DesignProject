...
UAV.kp_theta = 1*UAV.delta_e_max/UAV.e_theta_max*sign(UAV.a_theta3);
UAV.omega_n_theta = sqrt(UAV.a_theta2+UAV.delta_e_max/UAV.e_theta_max*abs(UAV.a_theta3));
UAV.zeta_theta = 0.7; %0.7
...
% altitude
UAV.W_h = 15; %bandwidth separation pitch and altitude
UAV.omega_n_h = UAV.omega_n_theta/UAV.W_h;
UAV.zeta_h = 1.5; % 0.707*2
UAV.ki_h = UAV.omega_n_h^2/(UAV.K_theta_DC*UAV.Va0);
UAV.kp_h = (2*UAV.zeta_h*UAV.omega_n_h)/(UAV.K_theta_DC*UAV.Va0);

% airspeed with Pitch
UAV.W_V2 = 8; % bandwidth separation
UAV.omega_n_V2 = UAV.omega_n_theta/UAV.W_V2;
UAV.zeta_V2 = 0.707*4; % 3
UAV.ki_V2 = -UAV.omega_n_V2^2/(UAV.K_theta_DC*UAV.gravity);
UAV.kp_V2 = (UAV.a_V1-2*UAV.zeta_V2*UAV.omega_n_V2)/(UAV.K_theta_DC*UAV.gravity);

% airspeed with throttle
UAV.omega_n_V = UAV.omega_n_V2;
UAV.zeta_V = 0.707; % 0.7
